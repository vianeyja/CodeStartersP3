...
var businessUrl = "static/js/comercio_4.json";
...
function createMap(markers) {
  ...
  L.control.layers(baseMaps, overlayMaps, {
    ...
    d3.json("static/js/estados-de-mexico-rich.geojson", function(data) {
    // Create a new choropleth layer
    geojson = L.choropleth(data, {
      // Define what  property in the features to use
      valueProperty: "Comercio",
      // Set color scale
      scale: ["#ffffb2", "#02b07f"],
      ...
      onEachFeature: function(feature, layer) {
        layer.bindPopup(feature.properties.estado + ", " + "<br>Total de empresas relacionadas a sector Comercio:<br>" +
        feature.properties.Comercio);
      }
    }).addTo(myMap);;
    // Set up the legend
